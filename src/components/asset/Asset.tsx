...
export const Asset: React.FC<AssetProps> = ({
  ...
  const sizeConfig = {
    lg: {
      ...
      nameStyle: 'font-display text-label-lg font-black leading-none uppercase text-shades-black ',
      tickerStyle: 'font-sans text-label-sm font-medium leading-none text-shades-dark',
    ...
    md: {
      ...
      parentLayout: 'flex-row',
      layout: 'flex-col gap-[4px]',
      nameStyle: 'font-sans text-body-sm font-medium leading-none text-shades-black ',
      tickerStyle: 'font-sans text-label-sm font-medium leading-none text-shades-semi-dark ',
    ...
    sm: {
      ...
      nameStyle: 'font-sans text-body-sm font-medium leading-none text-shades-black ',
      tickerStyle: 'font-sans text-body-sm font-medium leading-none text-shades-semi-dark ',
    ...
    xs: {
      ...
      parentLayout: 'flex-row items-center',
      layout: 'flex-row items-center',
      nameStyle: 'font-sans text-label-sm font-medium leading-none text-shades-black ',
      tickerStyle: 'font-sans text-label-sm font-medium leading-none text-shades-semi-dark ',

...
import type { Feature, FeatureSectionProps, FeatureSectionStyle } from './FeatureSection.types';

const styleClasses: Record<FeatureSectionStyle, { 
  bg: string; 
  heading: string; 
  featureTitle: string; 
...
interface FeatureItemProps {
  ...
  styles: typeof styleClasses[FeatureSectionStyle];
  isLast?: boolean;
}

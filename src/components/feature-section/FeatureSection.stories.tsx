...
const meta: Meta<typeof FeatureSection> = {
  title: 'Sections/Website/Feature Section',
...
const mockFeatures: FeatureSectionProps['features'] = [
  {
    id: '1',
...
const mockFeaturesWithImages: FeatureSectionProps['features'] = mockFeatures.map((feature) => ({
  ...feature,
  imageElement: (

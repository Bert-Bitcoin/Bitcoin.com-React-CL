...
function MyPage() {
  ...
  return <FeatureSection heading="Why Choose Us" features={features} />;
}
```
...
function ProductPage() {
  ...
  return <FeatureSection heading="What We Offer" features={features} />;
}
```
...
function InteractiveFeaturesPage() {
  ...
  return (
    <>
      <FeatureSection heading="Our Products" features={features} />

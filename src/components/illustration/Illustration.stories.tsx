...
// ========================================
// New Illustrations Showcase
// ========================================

export const NewIllustrations: Story = {
  name: 'New Illustrations',
  render: () => (
    <div className="flex flex-col gap-l max-w-6xl">
      <div>
        <h3 className="text-heading-md uppercase mb-s">Recently Added</h3>
        <p className="text-body text-text-secondary mb-m">
          New illustrations added to the library
        </p>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-m">
        <Card>
          <div className="flex flex-col gap-m">
            <Illustration
              src={illustrations.bitcoinCloud}
              alt="Bitcoin Cloud"
              aspectRatio="16/9"
              size="full"
              rounded
            ...
            />
            <Card.Header>
              <Card.Title variant="heading-sm">BITCOIN CLOUD</Card.Title>
              <Card.Description>Cloud-based Bitcoin services</Card.Description>
            </Card.Header>
          </div>
        </Card>
        <Card>
          <div className="flex flex-col gap-m">
            <Illustration
              src={illustrations.bitcoinEthereum}
              alt="Bitcoin & Ethereum"
              aspectRatio="16/9"
              size="full"
              rounded
              backgroundColor="rgb(var(--color-secondary-10))"
            />
            <Card.Header>
              <Card.Title variant="heading-sm">BITCOIN & ETHEREUM</Card.Title>
              <Card.Description>Multi-crypto trading</Card.Description>
            </Card.Header>
          </div>
        </Card>
        <Card>
          <div className="flex flex-col gap-m">
            <Illustration
              src={illustrations.bitcoinGamble}
              alt="Bitcoin Gamble"
              aspectRatio="16/9"
              size="full"
              rounded
            ...
            />
            <Card.Header>
              <Card.Title variant="heading-sm">BITCOIN GAMBLE</Card.Title>
              <Card.Description>Gaming and betting features</Card.Description>
            </Card.Header>
          </div>
        </Card>
        <Card>
          <div className="flex flex-col gap-m">
            <Illustration
              src={illustrations.bitcoinIllustration}
            ...
            />
            <Card.Header>
              <Card.Title variant="heading-sm">BITCOIN</Card.Title>
              <Card.Description>General Bitcoin concept</Card.Description>
            </Card.Header>
          </div>
        </Card>
        <Card>
          <div className="flex flex-col gap-m">
            <Illustration
              src={illustrations.bitcoinMachine}
              alt="Bitcoin Machine"
              aspectRatio="16/9"
              size="full"
              rounded
            ...
            />
            <Card.Header>
              <Card.Title variant="heading-sm">BITCOIN MACHINE</Card.Title>
              <Card.Description>ATM and physical machines</Card.Description>
            </Card.Header>
          </div>
        </Card>
        <Card>
          <div className="flex flex-col gap-m">
            ...
            />
            <Card.Header>
              <Card.Title variant="heading-sm">SEND BITCOIN</Card.Title>
              <Card.Description>Transfer and send features</Card.Description>
            </Card.Header>
          </div>
        </Card>
      </div>
